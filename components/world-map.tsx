...
const MISSION_CARDS: Record<string, MissionCard> = {
  start: {
    ...
    versions: [
      ...
      {
        name: "hardcore",
        problem: "¡Tranquilas, el zorro ya tiene su mochila lista! Pero antes de salir, necesita asegurarse de que todas las herramientas estén en orden!",
        challenge: "Divertirse personalizando su repositorio con un README creativo, etiquetas, y una estructura de carpetas organizada para cada zona de la ciudad.",
        deliverable: "Lo que",
      },
    ],
  },
